...
namespace gobi.pixi.settings {

	export let PREFER_WEBGL_2 = true;
	 ...
	 */
	export let PRECISION_VERTEX = gobi.core.PRECISION.HIGH;

	export let PRECISION_FRAGMENT = gobi.core.PRECISION.MEDIUM;

	//TODO: mobile device test
	export let SPRITE_MAX_TEXTURES = 32;

	export let CAN_UPLOAD_SAME_BUFFER = true;
