namespace gobi.pixi.graphicsUtils {
	 ...
	 */
	export function buildLine(graphicsData: GraphicsData, webGLData: WebGLGraphicsData) {
		if (graphicsData.nativeLines) {
			buildNativeLine(graphicsData, webGLData);
		}
		else {
			buildPolyLine(graphicsData, webGLData);
		}
	}
	 ...
	 * @param {object} webGLData - an object containing all the webGL-specific information to create this shape
	 */
	function buildPolyLine(graphicsData: GraphicsData, webGLData: WebGLGraphicsData) {
		// TODO OPTIMISE!
	 ...
	 * @param {object} webGLData - an object containing all the webGL-specific information to create this shape
	 */
	function buildNativeLine(graphicsData: GraphicsData, webGLData: WebGLGraphicsData) {
		let i = 0;
