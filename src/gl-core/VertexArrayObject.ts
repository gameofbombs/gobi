namespace gobi.glCore {
	...
	export class VertexArrayObject {
		...
		nativeState: GLAttribState = null;
		...
		constructor(gl: WebGLRenderingContext, state: GLAttribState) {
			...
			if (this.nativeVaoExtension) {
				...
				// VAO - overwrite the state..
				this.nativeState = new GLAttribState(state.tempAttribState.length);
			}
