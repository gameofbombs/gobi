///ts:ref=bitTwiddle
/// <reference path="../utils/bitTwiddle.ts"/> ///ts:ref:generated
...
namespace gobi.core {
	...
	export class BaseTexture implements UniqIdMarked, IDisposable {
		...
		setResolution(resolution: number) {
			...
			const rw = this.width * this.resolution, rh = this.height * this.resolution;
			this.resolution = resolution;
			this.width = rw / this.resolution;
			this.height = rh / this.resolution;
			this.update();
		}
